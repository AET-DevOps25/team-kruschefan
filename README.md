...
This use case diagram shows the main interactions users have with FormsAI. _Form Creators_ can create, view, delete, and share forms. They can also use the AI-powered form generation feature to generate forms. _Form Accessers_ can view and fill out forms that have been shared with them.
